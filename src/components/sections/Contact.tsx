          ...
          <div className="fade-in">
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-5 p-5 bg-cream-50 hover:bg-cream-100 rounded-2xl transition-colors group"
              >
                ...
                <div>
                  <p className="font-semibold text-warm-800">WhatsApp</p>
                ...
                <Icon
                  name="external-link"
                  className="w-4 h-4 text-warm-400 ml-auto"
                />
              </a>
              ...
              <a
                ...
                className="flex items-center gap-5 p-5 bg-cream-50 hover:bg-cream-100 rounded-2xl transition-colors group"
              >
                <div className="w-14 h-14 rounded-2xl bg-peach-100 flex items-center justify-center flex-shrink-0 group-hover:bg-peach-200 transition-colors">
                  <Icon name="mail" className="w-7 h-7 text-peach-400" />
                </div>
                <div>
                  <p className="font-semibold text-warm-800">Email</p>
                  <p className="text-warm-500 text-sm">{contactInfo.email}</p>
                </div>
                <Icon
                  name="external-link"
                  className="w-4 h-4 text-warm-400 ml-auto"
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-sage-100 flex items-center justify-center flex-shrink-0 group-hover:bg-sage-200 transition-colors">
                  <Icon name="instagram" className="w-7 h-7 text-sage-400" />
                </div>
                <div>
                  <p className="font-semibold text-warm-800">Instagram</p>
                  <p className="text-warm-500 text-sm">
